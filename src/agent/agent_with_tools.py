...
from src.llm.frank_provider_with_tools import FrankProviderWithTools, ToolDefinition
from src.agent.tools.file_tools import FileTools
from src.agent.tools.git_tools import GitTools


class WebsiteAgentWithTools:
    """
    Agent that can modify code in the cynditaylor-com website using an LLM with tools.
    """

    def __init__(self, llm_provider: FrankProviderWithTools, website_dir: str = "cynditaylor-com"):
        """
