...
from llm.frank_provider_with_tools import FrankProviderWithTools
from agent.agent_with_tools import WebsiteAgentWithTools
...
class TestWebsiteAgentWithTools(unittest.TestCase):
    ...
    @patch("agent.agent_with_tools.GitTools")
    ...
    @patch("agent.agent_with_tools.WebsiteAgentWithTools._list_files")
    @patch("agent.agent_with_tools.WebsiteAgentWithTools._read_file")
    @patch("agent.agent_with_tools.WebsiteAgentWithTools._write_file")
    @patch("agent.agent_with_tools.WebsiteAgentWithTools._commit_changes")
